 ...
 * Description    :
 * CreateAuthor: Cannan
 * CreateTime   : 2018/6/25     11:03
 * Project          : MyApplication3
 * PackageName :  com.lansent.cannan.util;
 */
...
public class AssetsUtils {
	...
	public static boolean checkApkExist(Context context, String packageName){
		...
		try {
			...
			Log.i(info.toString()); // Timber 是我打印 log 用的工具，这里只是打印一下 log
			return true;
		} catch (PackageManager.NameNotFoundException e) {
			Log.i(e.toString()); // Timber 是我打印 log 用的工具，这里只是打印一下 log
			return false;
		}
	}
